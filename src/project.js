    ...
    var a = e("../Common/Utils"),
      ...
      f = function (e) {
        ...
        return o(t, e), n = t, t.prototype.onLoad = function () {
          ...
          t.position = e, t.scale = .2, t.runAction(cc.sequence(cc.scaleTo(.3, 1.2), cc.fadeOut(.3))), t.children[0].runAction(cc.spawn(cc.moveBy(.5, -65, 65), cc.fadeOut(3))), t.children[1].runAction(cc.spawn(cc.moveBy(.5, 65, -65), cc.fadeOut(3))), t.children[2].runAction(cc.spawn(cc.moveBy(.5, -65, -65), cc.fadeOut(3))), t.children[3].runAction(cc.spawn(cc.moveBy(.5, 65, 65), cc.fadeOut(3)))
          ...
          for (var n = a.default.RandomInteger(32, 43), o = 0; o < n; o++) {
            ...
            var l = a.default.Random(.9, 1.2),
              u = a.default.Random(.2, .6);
            c.runAction(cc.sequence(cc.delayTime(u), cc.delayTime(l * a.default.Random(.4, .9)), cc.scaleTo(.8 * l, a.default.Random(.2, .3)))), c.opacity = 0, c.runAction(cc.sequence(cc.delayTime(u), cc.fadeTo(.8, a.default.Random(160, 240)))), c.runAction(cc.sequence(cc.delayTime(u), cc.moveBy(l, r.mul(s)).easing(cc.easeCubicActionOut()), cc.callFunc(function (e) {
              e.stopAllActions(), e.destroy()
            }, this)));
    ...
    var a = e("../common/PlayerInfo"),
      ...
      m = function (e) {
        ...
        return o(t, e), t.prototype.onLoad = function () {
          ...
          e.position = this.node.position, e.runAction(cc.sequence(cc.delayTime(3), cc.fadeOut(3)))
        }, t.prototype.createStar = function () {
          var e = r.default.Spawn("star", cc.find("Canvas/upEffectParent"));
          e.scale = s.default.Random(.1, 1);
          var t = this.node.x + this.node.width / 2,
